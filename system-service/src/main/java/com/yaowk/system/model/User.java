...
import com.yaowk.system.model.base.BaseUser;
...
public class User extends BaseUser<User> {
    ...
    public com.jfinal.plugin.activerecord.Page<User> paginate(Page page, Map condition) {
        ...
        DbCacheKit.addKey(key);
        com.jfinal.plugin.activerecord.Page<User> result = paginateByCache(CacheConstant.DB, key, page.getPageNumber(), page.getPageSize(), getSql("paginate-select"), sqlPara.getSql(), sqlPara.getPara());
